...
# TODO rewatch flask lecture DONE
# TODO rewatch section 
# TODO rewatch shorts 
# TODO go through and learn what all the code does
# TODO dowload and integrate flask and sql and set this app up to be used from my computer rather than CS550 VS code
# TODO then screenshot and  add to personal portfolio with description of what it is, how i did it etc.,
...
def index():
    ...
    for stock in stocks:
        ...
        if quote is not None:
            ...
            if "total_shares" in stock:
                stock["value"] = quote.get("price", 0) * stock["total_shares"]
                total_value += stock["value"]
                grand_total += stock["value"]
        else:
            # Handle case where stock information is not available
            stock["name"] = "N/A"
            stock["price"] = 0
            stock["value"] = 0
